...
fn main() -> Result<(), CryptoAPIError> {
    ...
    println!("Saving/owerwriting keys in dir: {}", path);
    ...
    // generate the RLWE and LWE secret keys
    ...
    let rlwe_params1: RLWEParams = RLWEParams{polynomial_size: 2048, dimension: 1, log2_std_dev: -60};
    let sk1_RLWE = RLWESecretKey::new(&rlwe_params1); 
